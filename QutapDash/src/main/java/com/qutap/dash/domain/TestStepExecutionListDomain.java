...
public class TestStepExecutionListDomain {
	...
	public String toString() {
		return "TestStepExecutionListDomain [StartDateTime=" + StartDateTime + ", EndDateTime=" + EndDateTime
				+ ", response=" + response + ", paramGroupObject=" + paramGroupObject + ", action=" + action
				+ ", runnerType=" + runnerType + ", error=" + error + ", testStepId=" + testStepId + ", status="
				+ status + ", duration=" + duration + ", screenShot=" + screenShot + ", testParamData=" + testParamData
				+ "]";
	}
